...
Global $sThis_ID = 'App2';Sender token
Global $sSend_ID = 'App1';Recipient token
...
Func _Send()
	...
	Local $vResponse = _Send_Connector($vSendMessage, $sSend_ID, $sThis_ID, Default, 0, @ScriptDir & '\' & $sSend_ID & '.au3'); sends message $ vSendMessage, from principal $ sThis_ID, to principal $ sSend_ID
	Local $iErr = @error
	If $iErr Then
